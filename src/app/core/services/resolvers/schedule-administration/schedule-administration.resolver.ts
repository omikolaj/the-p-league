...
import {
  Team,
  TEAMS
} from "../../../../views/schedule/models/interfaces/team.model";
...
export class ScheduleAdministrationResolver
  implements Resolve<Observable<League[]>> {
  private leaguesSubject: BehaviorSubject<League[]> = new BehaviorSubject<
    League[]
  >([]);
  ...
  resolve(
    ...
    | Observable<League[]>
    | Observable<Observable<League[]>>
    | Promise<Observable<League[]>> {
